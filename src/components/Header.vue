<template>
    <div class="box">
        <div class="nav">
            ...
            <ul class="detail">
                <li class="first">你好，请<a href="login.html">登录 </a>|<span class="text-color-red"><a href="signup.html">免费注册</a></span></li>
...
export default {
  ...
  data () {
    return {
      city: '珠海',
      cityArr: [['北京', '上海', '天津', '重庆', '广州'], ['深圳', '河南', '辽宁', '吉林', '江苏'], ['江西', '四川', '海南', '贵州', '云南'], ['西藏', '陕西', '甘肃', '青海', '珠海']]
    }
  },
  methods: {
    changeCity (city) {
