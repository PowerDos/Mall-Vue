...
CREATE TABLE `Audit`  (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  INDEX `DataChange_LastTime`(`DataChange_LastTime`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 228 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '日志审计表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `Audit` VALUES (222, 'Item', 180, 'INSERT', NULL, b'0', 'apollo', '2020-07-15 17:03:06', NULL, '2020-07-15 17:03:06');
INSERT INTO `Audit` VALUES (223, 'Item', 181, 'INSERT', NULL, b'0', 'apollo', '2020-07-15 17:03:06', NULL, '2020-07-15 17:03:06');
INSERT INTO `Audit` VALUES (224, 'Item', 182, 'INSERT', NULL, b'0', 'apollo', '2020-07-15 17:03:06', NULL, '2020-07-15 17:03:06');
INSERT INTO `Audit` VALUES (225, 'ItemSet', NULL, 'INSERT', NULL, b'0', 'apollo', '2020-07-15 17:03:06', NULL, '2020-07-15 17:03:06');
INSERT INTO `Audit` VALUES (226, 'Release', 7, 'INSERT', NULL, b'0', 'apollo', '2020-07-15 17:03:08', NULL, '2020-07-15 17:03:08');
INSERT INTO `Audit` VALUES (227, 'ReleaseHistory', 7, 'INSERT', NULL, b'0', 'apollo', '2020-07-15 17:03:08', NULL, '2020-07-15 17:03:08');
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'commit 历史表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `Commit` VALUES (7, '{\"createItems\":[{\"namespaceId\":6,\"key\":\"spring.zipkin.base-url\",\"value\":\"http://zipkin-port.mall-basic:9411\",\"comment\":\"\",\"lineNum\":52,\"id\":182,\"isDeleted\":false,\"dataChangeCreatedBy\":\"apollo\",\"dataChangeCreatedTime\":\"2020-07-15 17:03:05\",\"dataChangeLastModifiedBy\":\"apollo\",\"dataChangeLastModifiedTime\":\"2020-07-15 17:03:05\"}],\"updateItems\":[],\"deleteItems\":[]}', 'springcloudzuul', 'default', 'application', NULL, b'0', 'apollo', '2020-07-15 17:03:06', 'apollo', '2020-07-15 17:03:06');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '使用配置的应用实例' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of Instance
-- ----------------------------
INSERT INTO `Instance` VALUES (1, 'springcloudmember', 'default', '', '10.1.2.67', '2020-07-15 16:55:38', '2020-07-15 16:55:38');
INSERT INTO `Instance` VALUES (2, 'springcloudseckill', 'default', '', '10.1.2.67', '2020-07-15 16:55:43', '2020-07-15 16:55:43');
INSERT INTO `Instance` VALUES (3, 'springcloudremarks', 'default', '', '10.1.2.67', '2020-07-15 16:55:43', '2020-07-15 16:55:43');
INSERT INTO `Instance` VALUES (4, 'springcloudgoods', 'default', '', '10.1.2.67', '2020-07-15 16:55:46', '2020-07-15 16:55:46');
INSERT INTO `Instance` VALUES (5, 'springcloudorder', 'default', '', '10.1.2.67', '2020-07-15 16:55:46', '2020-07-15 16:55:46');
INSERT INTO `Instance` VALUES (6, 'springcloudzuul', 'default', '', '10.1.2.67', '2020-07-15 16:55:48', '2020-07-15 16:55:48');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '应用实例的配置信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of InstanceConfig
-- ----------------------------
INSERT INTO `InstanceConfig` VALUES (1, 1, 'springcloudmember', 'default', 'application', '20200710100508-0bf0e4c284dfa4de', '2020-07-15 16:55:38', '2020-07-15 16:55:38', '2020-07-15 16:55:38');
INSERT INTO `InstanceConfig` VALUES (2, 2, 'springcloudseckill', 'default', 'application', '20200710101254-f7b5e4c284dfa4e2', '2020-07-15 16:55:42', '2020-07-15 16:55:42', '2020-07-15 16:55:42');
INSERT INTO `InstanceConfig` VALUES (3, 3, 'springcloudremarks', 'default', 'application', '20200710100819-dc79e4c284dfa4e0', '2020-07-15 16:55:43', '2020-07-15 16:55:43', '2020-07-15 16:55:43');
INSERT INTO `InstanceConfig` VALUES (4, 4, 'springcloudgoods', 'default', 'application', '20200710100652-881ce4c284dfa4df', '2020-07-15 16:55:45', '2020-07-15 16:55:45', '2020-07-15 16:55:45');
INSERT INTO `InstanceConfig` VALUES (5, 5, 'springcloudorder', 'default', 'application', '20200710100953-5a14e4c284dfa4e1', '2020-07-15 16:55:46', '2020-07-15 16:55:46', '2020-07-15 16:55:46');
INSERT INTO `InstanceConfig` VALUES (6, 6, 'springcloudzuul', 'default', 'application', '20200715170308-f068dfa751239085', '2020-07-15 17:03:09', '2020-07-15 16:55:48', '2020-07-15 17:03:10');
...
CREATE TABLE `Item`  (
  ...
  INDEX `DataChange_LastTime`(`DataChange_LastTime`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 183 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配置项目' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `Item` VALUES (123, 5, '', '', '###rabbitmq地址配置', 25, b'0', 'apollo', '2020-07-10 10:12:52', 'apollo', '2020-07-10 10:12:52');
INSERT INTO `Item` VALUES (124, 5, 'spring.rabbitmq.addresses', 'rabbitmq-port.mall-basic:5672', '', 26, b'0', 'apollo', '2020-07-10 10:12:52', 'apollo', '2020-07-10 10:12:52');
INSERT INTO `Item` VALUES (125, 5, '', '', '###rabbitmq账号配置', 25, b'0', 'apollo', '2020-07-10 10:12:52', 'apollo', '2020-07-10 10:12:52');
...
INSERT INTO `Item` VALUES (180, 6, '', '', '', 50, b'0', 'apollo', '2020-07-15 17:03:06', 'apollo', '2020-07-15 17:03:06');
INSERT INTO `Item` VALUES (181, 6, '', '', '#zipkin', 51, b'0', 'apollo', '2020-07-15 17:03:06', 'apollo', '2020-07-15 17:03:06');
INSERT INTO `Item` VALUES (182, 6, 'spring.zipkin.base-url', 'http://zipkin-port.mall-basic:9411', '', 52, b'0', 'apollo', '2020-07-15 17:03:06', 'apollo', '2020-07-15 17:03:06');
...
INSERT INTO `Release` VALUES (7, '20200715170308-f068dfa751239085', '20200715170306-release', '', 'springcloudzuul', 'default', 'application', '{\"server.port\":\"8000\",\"spring.application.name\":\"spring-cloud-zuul\",\"eureka.client.service-url.defaultZone\":\"http://eureka-port.mall-basic:8080/eureka\",\"eureka.client.register-with-eureka\":\"true\",\"zuul.routes.api-a.path\":\"/api-order/**\",\"zuul.routes.api-a.service-id\":\"spring-cloud-order\",\"zuul.routes.api-b.path\":\"/api-member/**\",\"zuul.routes.api-b.service-id\":\"spring-cloud-member\",\"zuul.routes.api-c.path\":\"/api-goods/**\",\"zuul.routes.api-c.service-id\":\"spring-cloud-goods\",\"zuul.routes.api-d.path\":\"/api-remarks/**\",\"zuul.routes.api-d.service-id\":\"spring-cloud-remarks\",\"zuul.routes.api-e.path\":\"/api-seckill/**\",\"zuul.routes.api-e.service-id\":\"spring-cloud-seckill\",\"ribbon.ReadTimeout\":\"3000\",\"logging.config\":\"classpath:logback-zuul.xml\",\"logging.path\":\"/opt/logs/zuul\",\"spring.redis.host\":\"redis-port.mall-basic\",\"spring.redis.port\":\"6379\",\"spring.http.encoding.charset\":\"UTF-8\",\"spring.http.encoding.enabled\":\"true\",\"spring.http.encoding.force\":\"true\",\"zuul.routes.sensitive-headers\":\"\",\"spring.zipkin.base-url\":\"http://zipkin-port.mall-basic:9411\"}', b'0', b'0', 'apollo', '2020-07-15 17:03:08', 'apollo', '2020-07-15 17:03:08');
...
INSERT INTO `ReleaseHistory` VALUES (7, 'springcloudzuul', 'default', 'application', 'default', 7, 6, 0, '{\"isEmergencyPublish\":false}', b'0', 'apollo', '2020-07-15 17:03:08', 'apollo', '2020-07-15 17:03:08');
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '发布消息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ReleaseMessage` VALUES (7, 'springcloudzuul+default+application', '2020-07-15 17:03:08');
