...
public interface PayServiceApi {
    ...
    BaseResponseStruct<JSONObject> pay(@RequestParam("payToken") String payToken, HttpServletResponse response);
    ...
    BaseResponseStruct<JSONObject> queryPayStatue(@RequestBody String body, @RequestHeader("payToken")String payToken);
}
