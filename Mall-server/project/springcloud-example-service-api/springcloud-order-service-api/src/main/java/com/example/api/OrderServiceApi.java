...
public interface OrderServiceApi {
    ...
    BaseResponseStruct<JSONObject> prePay(@RequestBody PayInfoDTOInput payList, HttpServletRequest request);
    ...
    BaseResponseStruct<JSONObject> loadOrders(@RequestHeader("userToken") String userToken);
}
