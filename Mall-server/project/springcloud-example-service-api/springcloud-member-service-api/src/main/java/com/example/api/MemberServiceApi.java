...
public interface MemberServiceApi {
    ...
    BaseResponseStruct<UserDTOOutput> existMobile(@RequestParam("mobile") String mobile);
    ...
    BaseResponseStruct<UserDTOOutput> getInfo(@RequestParam("token") String token);
}
