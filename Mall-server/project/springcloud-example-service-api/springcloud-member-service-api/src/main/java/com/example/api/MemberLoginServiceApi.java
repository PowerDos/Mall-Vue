...
@Api(tags = "用户登陆服务接口")
public interface MemberLoginServiceApi {
    /**
     * 用户登陆接口
     *
    ...
    BaseResponseStruct<JSONObject> login(@RequestBody UserLoginInpDTO userLoginInpDTO, HttpServletRequest request);
    ...
    BaseResponseStruct<JSONObject> signOut(HttpServletRequest request);
    ...
    BaseResponseStruct<JSONObject> checkLoginStatue(@RequestHeader("loginToken") String loginToken);
