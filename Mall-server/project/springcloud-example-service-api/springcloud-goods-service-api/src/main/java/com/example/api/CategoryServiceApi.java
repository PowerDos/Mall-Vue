...
public interface CategoryServiceApi {
    ...
    BaseResponseStruct<JSONObject> getGoodsRootCategory();
    ...
    BaseResponseStruct<JSONObject> getGoodsCategories();
    ...
    BaseResponseStruct<JSONObject> getGoodsAttributes(@RequestHeader("categoryId")Long categoryId);
