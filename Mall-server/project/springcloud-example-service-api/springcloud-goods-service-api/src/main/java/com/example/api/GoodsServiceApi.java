...
public interface GoodsServiceApi {
    ...
    BaseResponseStruct<JSONObject> getGoodsLists(@RequestHeader("categoryId") Long categoryId);
    ...
    BaseResponseStruct<JSONObject> searchGoodsLists(@RequestHeader String searchStr);
    ...
    BaseResponseStruct<JSONObject> getGoodDetail(@RequestHeader Long productId);
    ...
    BaseResponseStruct<JSONObject> getGoodDetailSeckill(@RequestHeader("productId") Long productId, @RequestHeader("specsId") Long specsId);
    ...
    BaseResponseStruct<JSONObject> handleGoodStorage(@RequestBody List<HandleGoodStorage> transformData);
}
