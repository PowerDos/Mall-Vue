...
public interface UserTokenMapper {
    ...
    @Select("SELECT token  FROM example_user_token WHERE user_id=#{userId} AND login_type=#{loginType} and disable ='0'; ")
    String getTokenByUserIdAndLoginType(@Param("userId") Long userId, @Param("loginType") String loginType);
