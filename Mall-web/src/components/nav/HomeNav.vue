  ...
  <div>
    ...
    <div class="nav-body">
      ...
      <div class="nav-side" ref="navSide">
        <ul>
          <li v-for="(category,index) in categories" :key="category.type" @mouseenter="showDetail(index)"
    ...
    <transition name="fade">
      <div class="detail-item-panel panel-1" :duration="{ enter: 100, leave: 100 }" v-show="panel"
           @mouseenter="showDetail(categoryIndex)" ref="itemPanel" @mouseleave="hideDetail()">
