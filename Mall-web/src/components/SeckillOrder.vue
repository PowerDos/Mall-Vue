<template>
  <div>
    ...
    <div class="goods-list-container">
      ...
      <Table border ref="selection" :columns="columns" :data="secKillCart" size="large" @on-selection-change="select"
      ...
      <div class="pay-container">
        <div class="pay-box">
          ...
          <div class="pay-btn">
            <router-link to="/Pay">
              <Button type="error" size="large" @click="prePay">支付订单</Button>
            </router-link>
          </div>
        </div>
      </div>
